  ...
  <div>
    <div class="content">
      ...
      <PageHeader
        ...
        pageName="Log Hours for Multiple Youths"
      ></PageHeader>
      <div class="loghours-page">
        ...
        <br />
        <b-button @click="addButtonClicked" variant="success"
          >Add a youth to log</b-button
        >
        <br />
        <h3>Hours</h3>
        <div
      ...
      <b-modal hide-footer v-model="addModalVisible">
        ...
        <div class="add-form">
          <h2
            style="text-align: center"
            v-b-tooltip.hover
            title="If a youth is not active, head over to Manager Periods and change it first"
          >
            Select an active youth!
          </h2>
        ...
        <b-button class="mt-3" block @click="closeAddModal" variant="danger"
          >Cancel</b-button
        >
        <b-button class="mt-3" block @click="addYouth" variant="success"
          >Add to logging list</b-button
        >
      </b-modal>

      <!-- Loading Modal -->
      <b-modal
        v-model="loadingModalVisbile"
        hide-footer
        lazy
        hide-header-close
        no-close-on-esc
    ...
    async handleSubmit() {
      ...
      for (let youth of this.profilesToAdd) {
        ...
        try {
          ...
          window.alert(
            "Error on setting new Globl Pending Hours Entry, error: " + err
          );
        }
