<template>
  <div>
      ...
      <div class="container">
        ...
        <b-collapse class="navbar-collapse" id="navcol-1">
          ...
          <span class="navbar-text actions">
            <a class="nav_button" href="/Home" v-if="show_logout_option"
              >Dashboard</a
            >
            <a
              class="nav_button"
              href="/emergency-contacts"
              v-if="show_logout_option && isStaff"
              >Emergency</a
            >
            <a
    ...
    <div v-if="addPadding" class="under_navbar_padding"></div>
  </div>
</template>
